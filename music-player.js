...
.vinyl {
  ...
  top: 50%;
  left: 50%;
  /* Default position: partially hidden, ready to slide out */
  transform: translate(-38%, -50%); 
  border-radius: 50%;
  background: url("images/vinyl.png") no-repeat center/cover;
  z-index: 1;
...
/* When playing, slide vinyl out and spin */
.vinyl.playing {
...
/* Updated keyframes for orange and yellow colors */
@keyframes animate {
  0% {
    height: 20%;
